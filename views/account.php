            ...
            <div class="row">
                <div class="col-lg-offset-3 col-lg-6 col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10 col-xs-12 text-center">
                    <div id="account-block">                        
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-center">                                
                                <img src="https://image.flaticon.com/icons/svg/37/37943.svg" height="150" alt="avatar"/>
                            </div>
                            <input type="file" name="update-image" id="update-image" value="modifier l'image" />
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <p class="h4">Type d'utilisateur : <?= $_SESSION['auth']['type'] ?></p>                                
                                <p class="h4">Date d'inscription : <?= $_SESSION['auth']['confirmed_at'] ?></p>  
                                
                                <?php if (isset($_POST['profil-submit'])){
                                ...
                                <form id="update-account" action="#" method="POST">
                                    ...
                                    <div id="profil-old-control">
                                        <label class="form-labels" for="profil-birthdate">date de naissance : </label>
                                    ...
                                    <div id="profil-subtype-control" class="<?= $_SESSION['auth']['type'] == 'particulier' ? 'hidden' : '';?>">
